...
`^GSPC`, 502 weekly log returns,
dt = 0.019231.  Snapshot 2026-08-18T08:43:40+00:00.
...
|:------------|------------:|---------:|--------:|---------:|-------------:|------------------:|------------------------:|
| moments     |     0.39047 | -0.25894 | 0.16088 | 0.036882 |      0.16839 |         -0.1652   |                  6.7135 |
| MLE         |     0.33194 | -0.20041 | 0.15925 | 0.022997 |      0.16212 |         -0.084285 |                  3.8352 |

The method of moments reproduces the sample moments it targets, as it must:

| moment          |       sample |   fitted (moments) |
|:----------------|-------------:|-------------------:|
| var             |  0.000545282 |        0.000545282 |
| skewness        | -1.19129     |       -1.19129     |
| excess_kurtosis |  6.71352     |        6.71352     |

## Why the two estimators disagree

They differ by a factor of 1.6 in `nu` (0.03688 by
moments, 0.02300 by likelihood), and the reason is structural rather
than numerical.

The Gamma clock's shape over one step is `dt/nu`: 0.521 at the moment
estimate, 0.836 at the MLE.  Below `1/2` the VG density has a power
...
the moment fit, 1.7% of weekly returns should land within
1e-4 of the drift -- essentially "nothing happened today".  In the actual
`^GSPC` series 0.4% do.  Markets trade continuously
...
`fig_05_physical_fit_weekly.png` shows the point of the whole exercise.
...
6.71 against 0 for the normal, sample skewness
-1.19 against 0.  The QQ panel shows where it still
