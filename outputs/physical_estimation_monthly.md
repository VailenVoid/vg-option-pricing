...
`^GSPC`, 119 monthly log returns,
dt = 0.083333.  Snapshot 2026-08-18T08:43:40+00:00.
...
|:------------|------------:|---------:|--------:|--------:|-------------:|------------------:|------------------------:|
| moments     |     0.24338 | -0.11995 | 0.17349 | 0.50492 |      0.19329 |          -0.87905 |                 24.558  |
| MLE         |     0.20759 | -0.0839  | 0.17893 | 0.16667 |      0.18218 |          -0.22755 |                  6.4167 |

The method of moments reproduces the sample moments it targets, as it must:

| moment          |     sample |   fitted (moments) |
|:----------------|-----------:|-------------------:|
| var             |  0.0031135 |          0.0031135 |
| skewness        | -3.04512   |         -3.04512   |
| excess_kurtosis | 24.5582    |         24.5582    |

## Why the two estimators disagree

They differ by a factor of 3.0 in `nu` (0.50492 by
moments, 0.16667 by likelihood), and the reason is structural rather
than numerical.

The Gamma clock's shape over one step is `dt/nu`: 0.165 at the moment
estimate, 0.500 at the MLE.  Below `1/2` the VG density has a power
...
the moment fit, 13.8% of monthly returns should land within
1e-4 of the drift -- essentially "nothing happened today".  In the actual
`^GSPC` series 0.0% do.  Markets trade continuously
...
`fig_05_physical_fit_monthly.png` shows the point of the whole exercise.
...
24.56 against 0 for the normal, sample skewness
-3.05 against 0.  The QQ panel shows where it still
